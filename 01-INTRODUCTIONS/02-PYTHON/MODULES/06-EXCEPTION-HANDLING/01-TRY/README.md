...
-------------------------------------------------------
The try statement is the foundation of Python’s exception
handling system. It allows a program to test code for errors without immediately 
stopping execution when a runtime problem occurs.
...
It only marks code that might fail. Handling happens later using except, else, or finally.
-----------------------------------------------------------------------
✅ Best Practices
